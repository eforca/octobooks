...
stat_cats <- c(
    "genre", "langue_vo", "genders",
    "langue", "format", "owner", "keywords", "score"
)
...
char_cols <- c(
    "isbn", "title", "title_vo", "authors", "translators", "interpreters",
